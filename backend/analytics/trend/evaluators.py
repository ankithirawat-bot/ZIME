...
:class:`EvaluatorResult`. No single signal determines the final trend: the
...
from backend.analytics.trend.models import EvaluatorResult, SignalOutput

_WEIGHT_KEYS = {
    "ma_alignment": "weight_ma",
...
class WeightedEvaluator:
    ...
    def evaluate(
        ...
        Args:
            ...
            config:  Trend configuration (provides weights).
        ...
        weights = [getattr(config, _WEIGHT_KEYS.get(o.name, "weight_ma")) for o in available]
