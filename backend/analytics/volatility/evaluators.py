...
:class:`EvaluatorResult`. No single signal determines the final volatility:
...
from backend.analytics.volatility.models import EvaluatorResult, SignalOutput

_WEIGHT_KEYS = {
    "historical_volatility": "weight_hv",
    "volatility_trend": "weight_vol_trend",
    "range_expansion": "weight_range_expansion",
...
class WeightedEvaluator:
    ...
    def evaluate(
        ...
        Args:
            ...
            config:  Volatility configuration (provides weights).
        ...
        weights = [
            getattr(config, _WEIGHT_KEYS.get(o.name, "weight_hv"))
            for o in available
        ]
