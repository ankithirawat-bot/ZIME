...
class VolatilityEngine:
    ...
    def __init__(
        ...
        self._scorer = scorer or VolatilityScorer()

    def analyze(self, context: AnalyticsContext) -> AnalyticsFact:
        """Analyze volatility and return an explainable analytics fact.

        Args:
            context: Normalized market data, corporate actions and config.

        Returns:
            AnalyticsFact named "Volatility" with state, confidence and evidence.
        """
