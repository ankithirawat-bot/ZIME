...
class RelativeStrengthEngine:
    ...
    def __init__(
        ...
        self._scorer = scorer or RelativeStrengthScorer()

    def analyze(self, context: AnalyticsContext) -> AnalyticsFact:
        """Analyze relative strength and return an explainable analytics fact.

        Args:
            context: Normalized market data, peer series and config.

        Returns:
            AnalyticsFact named "Relative Strength" with state, confidence and
            evidence.
        """
